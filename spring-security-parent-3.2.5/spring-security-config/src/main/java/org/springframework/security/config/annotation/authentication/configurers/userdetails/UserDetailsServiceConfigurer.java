 ...
 * 
 * <p> 允许在AuthenticationManagerBuilder中配置UserDetailsService。
 *
 * @author Rob Winch
 * @since 3.2
 *
 ...
 * 
 * <p> 用于允许返回具体UserDetailsService的UserDetailsService的类型。
 */
public class UserDetailsServiceConfigurer<B extends ProviderManagerBuilder<B>,
     ...
     * schema, etc.
     * 
     * <p> 允许子类初始化UserDetailsService。 例如，它可能会添加用户，初始化架构等。
     */
