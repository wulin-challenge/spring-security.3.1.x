...
public interface SecurityConfigurer<O, B extends SecurityBuilder<O>> {
     ...
     * 
     * <p> 初始化SecurityBuilder。 在这里，仅应创建和修改共享状态，而不能在用于构建对象的SecurityBuilder上创建和修改属性。 
     * 这样可以确保在构建时configure（SecurityBuilder）方法使用正确的共享库。
     *
     * @param builder
     * @throws Exception
     */
     ...
     * 
     * <p> 通过在SecurityBuilder上设置必要的属性来配置SecurityBuilder。
     *
     * @param builder
     * @throws Exception
     */
