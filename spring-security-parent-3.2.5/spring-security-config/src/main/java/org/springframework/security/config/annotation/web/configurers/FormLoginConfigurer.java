 ...
 * 
 * <p> 添加基于表单的身份验证。 所有属性都有合理的默认值，使得所有参数都是可选的。 
 * 如果未指定loginPage（String），则框架将生成默认登录页面。
 *
 ...
 * <p> 创建共享对象
 *
 * <p> The following shared objects are populated
 * 
 * <p> 填充以下共享库
 *
 * <ul>
