...
/**
 * Configures LDAP {@link AuthenticationProvider} in the
...
public class LdapAuthenticationProviderConfigurer<B extends ProviderManagerBuilder<B>>
	 ...
	 *
	 * @param ldapAuthoritiesPopulator the {@link LdapAuthoritiesPopulator} the
	 *                                 default is
	...
	/**
	 * Specifies the {@link BaseLdapPathContextSource} to be used. If not specified,
	 * an embedded LDAP server will be created using {@link #contextSource()}.
	 *
	 * @param contextSource the {@link BaseLdapPathContextSource} to use
	 * @return the {@link LdapAuthenticationProviderConfigurer} for further
	 *         customizations
	...
	/**
	 * Specifies the
	 * {@link org.springframework.security.crypto.password.PasswordEncoder} to be
	 * used when authenticating with password comparison.
	 *
	...
	/**
	 * If your users are at a fixed location in the directory (i.e. you can work out
	 * the DN directly from the username without doing a directory search), you can
	 * use this attribute to map directly to the DN. It maps directly to the
	 * userDnPatterns property of AbstractLdapAuthenticator. The value is a specific
	 * pattern used to build the user's DN, for example "uid={0},ou=people". The key
	...
	public final class PasswordCompareConfigurer {
		 ...
		 * "userPassword".
		 *
		 * @param passwordAttribute the attribute in the directory which contains the
		 *                          user password
	...
	/**
	 * Allows building a {@link BaseLdapPathContextSource} and optionally creating
	 * an embedded LDAP instance.
	 *
	 * @author Rob Winch
	 * @since 3.2
	 */
	public final class ContextSourceBuilder {
		 ...
		 * which will be used to authenticate to a (non-embedded) LDAP server. If
		 * omitted, anonymous access will be used.
		 *
