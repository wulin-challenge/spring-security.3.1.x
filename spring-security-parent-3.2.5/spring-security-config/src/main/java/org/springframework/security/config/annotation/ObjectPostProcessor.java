 ...
 * 
 * <p> 允许初始化对象。 通常，这用于调用Aware方法InitializingBean.afterPropertiesSet（），并确保已调用DisposableBean.destroy（）。
 *
 * @param <T> the bound of the types of Objects this {@link ObjectPostProcessor} supports.
 * 
 * <p> 此ObjectPostProcessor支持的对象类型的界限。
 *
 * @author Rob Winch
 * @since 3.2
 */
public interface ObjectPostProcessor<T> {
     ...
     * be used instead.
     * 
     * <p> 初始化对象可能会返回应使用的修改后的实例。
     *
     * @param object the object to initialize - 要初始化的对象
     * @return the initialized version of the object - 对象的初始化版本
     */
