 ...
 * 
 * <p> @Controller的同义词，但仅用于框架提供的端点（因此，它永远不会与@Controller定义的用户自己的端点冲突）。 与@RequestMapping和所有其他
 * @Controller功能一起使用（并与Servlet上下文中的FrameworkEndpointHandlerMapping匹配）。
 * 
 * <p>
 ...
 * </p>
 * 
 * <p> Spring Security OAuth2 XSD命名空间的用户无需显式使用此功能，因为相关的处理程序将由解析器注册。
 * 
 * @author Dave Syer
 * 
 */
