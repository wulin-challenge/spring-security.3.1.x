 ...
 * 和其他由Grant类型决定的参数的请求。 支持的授予类型由提供的令牌授予者处理。
 * 
 * <p>
 ...
 * </p>
 * 
 * <p> 必须使用Spring Security Authentication对客户端进行身份验证才能访问此端点，并且从身份验证令牌中提取客户端ID。 
 * 安排此操作的最佳方法（根据OAuth2规范）是为此端点使用HTTP基本身份验证，并提供标准的Spring Security支持。
 * 
 * @author Dave Syer
 * 
 */
